...
static utInlineC void utSetUsedSymtab(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.usedSymtab, true);
    utRootData.usedSymtab = value;
    utRecordGlobal(utModuleID, 4, &utRootData.usedSymtab, false);}
static utInlineC void utSetAllocatedSymtab(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.allocatedSymtab, true);
    utRootData.allocatedSymtab = value;
...
static utInlineC void utSetUsedSymtabTable(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedSymtabTable, true);
    utRootData.usedSymtabTable = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedSymtabTable, false);}
static utInlineC void utSetAllocatedSymtabTable(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedSymtabTable, true);
    utRootData.allocatedSymtabTable = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedSymtabTable, false);}
static utInlineC void utSetFreeSymtabTable(int32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.freeSymtabTable, true);
    utRootData.freeSymtabTable = value;
...
static utInlineC void utSetUsedSym(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.usedSym, true);
    utRootData.usedSym = value;
    utRecordGlobal(utModuleID, 4, &utRootData.usedSym, false);}
static utInlineC void utSetAllocatedSym(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.allocatedSym, true);
    utRootData.allocatedSym = value;
...
static utInlineC void utSetUsedSymName(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedSymName, true);
    utRootData.usedSymName = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedSymName, false);}
static utInlineC void utSetAllocatedSymName(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedSymName, true);
    utRootData.allocatedSymName = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedSymName, false);}
static utInlineC void utSetFreeSymName(int32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.freeSymName, true);
    utRootData.freeSymName = value;
...
static utInlineC void utSetFirstFreeDynarray(utDynarray value) {
    utRecordGlobal(utModuleID, 4, &utRootData.firstFreeDynarray, true);
    utRootData.firstFreeDynarray = (value);
...
static utInlineC void utSetUsedDynarray(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.usedDynarray, true);
    utRootData.usedDynarray = value;
    utRecordGlobal(utModuleID, 4, &utRootData.usedDynarray, false);}
static utInlineC void utSetAllocatedDynarray(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.allocatedDynarray, true);
    utRootData.allocatedDynarray = value;
...
static utInlineC void utSetUsedDynarrayValue(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedDynarrayValue, true);
    utRootData.usedDynarrayValue = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedDynarrayValue, false);}
static utInlineC void utSetAllocatedDynarrayValue(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedDynarrayValue, true);
    utRootData.allocatedDynarrayValue = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedDynarrayValue, false);}
static utInlineC void utSetFreeDynarrayValue(int32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.freeDynarrayValue, true);
    utRootData.freeDynarrayValue = value;
...
static utInlineC void utSetFirstFreeSymArray(utSymArray value) {
    utRecordGlobal(utModuleID, 4, &utRootData.firstFreeSymArray, true);
    utRootData.firstFreeSymArray = (value);
...
static utInlineC void utSetUsedSymArray(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.usedSymArray, true);
    utRootData.usedSymArray = value;
    utRecordGlobal(utModuleID, 4, &utRootData.usedSymArray, false);}
static utInlineC void utSetAllocatedSymArray(uint32 value) {
    utRecordGlobal(utModuleID, 4, &utRootData.allocatedSymArray, true);
    utRootData.allocatedSymArray = value;
...
static utInlineC void utSetUsedSymArraySym(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedSymArraySym, true);
    utRootData.usedSymArraySym = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.usedSymArraySym, false);}
static utInlineC void utSetAllocatedSymArraySym(uint32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedSymArraySym, true);
    utRootData.allocatedSymArraySym = value;
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.allocatedSymArraySym, false);}
static utInlineC void utSetFreeSymArraySym(int32 value) {
    utRecordGlobal(utModuleID, sizeof(uint32), &utRootData.freeSymArraySym, true);
    utRootData.freeSymArraySym = value;
...
static utInlineC void utSymtabSetTableIndex(utSymtab Symtab, uint32 value) {
    utRecordField(utModuleID, 0, utSymtab2ValidIndex(Symtab), true);
    utSymtabs.TableIndex[utSymtab2ValidIndex(Symtab)] = value;
...
static utInlineC void utSymtabSetNumTable(utSymtab Symtab, uint32 value) {
    utRecordField(utModuleID, 1, utSymtab2ValidIndex(Symtab), true);
    utSymtabs.NumTable[utSymtab2ValidIndex(Symtab)] = value;
...
static utInlineC void utSymtabSetTable(utSymtab Symtab, utSym *valuePtr, uint32 numTable) {
    ...
    utRecordArray(utModuleID, 2, utSymtabGetTableIndex(Symtab), utSymtabGetNumTable(Symtab), true);
...
static utInlineC void utSymtabSetiTable(utSymtab Symtab, uint32 x, utSym value) {
    ...
    utRecordField(utModuleID, 2, utSymtabGetTableIndex(Symtab) + (x), true);
...
static utInlineC void utSymtabSetNumSym(utSymtab Symtab, uint32 value) {
    utRecordField(utModuleID, 3, utSymtab2ValidIndex(Symtab), true);
    utSymtabs.NumSym[utSymtab2ValidIndex(Symtab)] = value;
...
static utInlineC void utSymSetNameIndex(utSym Sym, uint32 value) {
    utRecordField(utModuleID, 4, utSym2ValidIndex(Sym), true);
    utSyms.NameIndex[utSym2ValidIndex(Sym)] = value;
...
static utInlineC void utSymSetNumName(utSym Sym, uint32 value) {
    utRecordField(utModuleID, 5, utSym2ValidIndex(Sym), true);
    utSyms.NumName[utSym2ValidIndex(Sym)] = value;
...
static utInlineC void utSymSetName(utSym Sym, char *valuePtr, uint32 numName) {
    ...
    utRecordArray(utModuleID, 6, utSymGetNameIndex(Sym), utSymGetNumName(Sym), true);
...
static utInlineC void utSymSetiName(utSym Sym, uint32 x, char value) {
    ...
    utRecordField(utModuleID, 6, utSymGetNameIndex(Sym) + (x), true);
...
static utInlineC void utSymSetHashValue(utSym Sym, uint32 value) {
    utRecordField(utModuleID, 7, utSym2ValidIndex(Sym), true);
    utSyms.HashValue[utSym2ValidIndex(Sym)] = value;
...
static utInlineC void utSymSetNext(utSym Sym, utSym value) {
    utRecordField(utModuleID, 8, utSym2ValidIndex(Sym), true);
    utSyms.Next[utSym2ValidIndex(Sym)] = value;
...
static utInlineC void utDynarraySetValueIndex(utDynarray Dynarray, uint32 value) {
    utRecordField(utModuleID, 9, utDynarray2ValidIndex(Dynarray), true);
    utDynarrays.ValueIndex[utDynarray2ValidIndex(Dynarray)] = value;
...
static utInlineC void utDynarraySetNumValue(utDynarray Dynarray, uint32 value) {
    utRecordField(utModuleID, 10, utDynarray2ValidIndex(Dynarray), true);
    utDynarrays.NumValue[utDynarray2ValidIndex(Dynarray)] = value;
...
static utInlineC void utDynarraySetValue(utDynarray Dynarray, uint8 *valuePtr, uint32 numValue) {
    ...
    utRecordArray(utModuleID, 11, utDynarrayGetValueIndex(Dynarray), utDynarrayGetNumValue(Dynarray), true);
...
static utInlineC void utDynarraySetiValue(utDynarray Dynarray, uint32 x, uint8 value) {
    ...
    utRecordField(utModuleID, 11, utDynarrayGetValueIndex(Dynarray) + (x), true);
...
static utInlineC void utDynarraySetValueSize(utDynarray Dynarray, uint16 value) {
    utRecordField(utModuleID, 12, utDynarray2ValidIndex(Dynarray), true);
    utDynarrays.ValueSize[utDynarray2ValidIndex(Dynarray)] = value;
...
static utInlineC void utDynarraySetUsedValue(utDynarray Dynarray, uint32 value) {
    utRecordField(utModuleID, 13, utDynarray2ValidIndex(Dynarray), true);
    utDynarrays.UsedValue[utDynarray2ValidIndex(Dynarray)] = value;
...
static utInlineC void utDynarraySetSize(utDynarray Dynarray, uint32 value) {
    utRecordField(utModuleID, 14, utDynarray2ValidIndex(Dynarray), true);
    utDynarrays.Size[utDynarray2ValidIndex(Dynarray)] = value;
...
static utInlineC void utDynarraySetFreeList(utDynarray Dynarray, utDynarray value) {
    utRecordField(utModuleID, 15, utDynarray2ValidIndex(Dynarray), true);
    utDynarrays.FreeList[utDynarray2ValidIndex(Dynarray)] = value;
...
static utInlineC void utSymArraySetSymIndex(utSymArray SymArray, uint32 value) {
    utRecordField(utModuleID, 16, utSymArray2ValidIndex(SymArray), true);
    utSymArrays.SymIndex[utSymArray2ValidIndex(SymArray)] = value;
...
static utInlineC void utSymArraySetNumSym(utSymArray SymArray, uint32 value) {
    utRecordField(utModuleID, 17, utSymArray2ValidIndex(SymArray), true);
    utSymArrays.NumSym[utSymArray2ValidIndex(SymArray)] = value;
...
static utInlineC void utSymArraySetSym(utSymArray SymArray, utSym *valuePtr, uint32 numSym) {
    ...
    utRecordArray(utModuleID, 18, utSymArrayGetSymIndex(SymArray), utSymArrayGetNumSym(SymArray), true);
...
static utInlineC void utSymArraySetiSym(utSymArray SymArray, uint32 x, utSym value) {
    ...
    utRecordField(utModuleID, 18, utSymArrayGetSymIndex(SymArray) + (x), true);
...
static utInlineC void utSymArraySetUsedSym(utSymArray SymArray, uint32 value) {
    utRecordField(utModuleID, 19, utSymArray2ValidIndex(SymArray), true);
    utSymArrays.UsedSym[utSymArray2ValidIndex(SymArray)] = value;
...
static utInlineC void utSymArraySetFreeList(utSymArray SymArray, utSymArray value) {
    utRecordField(utModuleID, 20, utSymArray2ValidIndex(SymArray), true);
    utSymArrays.FreeList[utSymArray2ValidIndex(SymArray)] = value;
